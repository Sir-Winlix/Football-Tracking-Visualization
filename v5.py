...
class FootballTrackingApp:
    ...
    def load_file(self):
        ...
        if file_path:
            ...
            # Seleccionar columnas necesarias (con comprobación para la columna 'teamAbbr' y 'jerseyNumber')
    ...
    def animate_play(self):
        ...
        for nfl_id in play_data['nflId'].dropna().unique():
            ...
            if 'jerseyNumber' in player_info.index:
                label += f" (Dorsal: {int(player_info['jerseyNumber'])})"
